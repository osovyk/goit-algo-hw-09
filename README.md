...
### Жадібний алгоритм
- **Складність**: O(n)
- **Швидкість**: Швидкий, але не завжди оптимальний.
  
### Алгоритм динамічного програмування
- **Складність**: O(n * m)
- **Швидкість**: Повільніший, але завжди оптимальний.

### Висновки
- Жадібний алгоритм працює швидше, але може не дати оптимальний результат в усіх випадках.
- Алгоритм динамічного програмування завжди забезпечує оптимальне рішення, проте його швидкість знижується для великих сум.